...
local hamstring =			{1715,7372,7373,25212}	-- pruned
...
local pummel =				{6552,6554}	-- pruned
local revenge =				{6572,6574,7379,11600,11601,25288,25269,30357}
local overpower =			{7384,7887,11584,11585}	-- pruned
local sunderArmor =			{7386,7405,8380,11596,11597,25225}	-- pruned
local intercept =			{20252,20616,20617,25272,25275}	-- pruned
local mortalStrike =		{12294,21551,21552,21553,25248,30330}
local devastate =			{20243,30016,30022}
local bloodthirst =			{23881,23892,23893,23894,25251,30335}	-- pruned
local shieldSlam =			{23922,23923,23924,23925,25258,30356}
local rampage =				{29801,30030,30033}	-- pruned
